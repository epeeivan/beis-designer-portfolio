export default {
  betmomo: {
    ...
    description:
      "as part of the expansion of their visibility, the bookmaker betmomo organised two concerts in the cities of douala and Yaoundé. We therefore produced a web platform design in line with the event's graphic charter, offering bookmaker users the chance to win free tickets for the concerts.",
  },
  bewallet: {
    title: "bewallet",
  ...
  mesagoo: {
    ...
    description:
      "Platform providing an interface for sending messages. We created the complete design of the platform (landing page, administration panel, client section).",
  },
  stellar: {
    title: "stellar",
  ...
  portfolio: {
    ...
    description:
      "Portfolio presenting a summary of the various fields in which we have established ourselves and the related achievements.",
  },
  myhome: {
    title: "Myhome237",
